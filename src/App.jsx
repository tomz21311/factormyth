...
const CATEGORIES = [
  ...
  { id: "food", name: "Food", emoji: "🍕", color: "#F59E0B", bg: "#FFFBEB", accent: "#D97706" },
];
...
const MYTHS_AND_FACTS = [
  ...
  { category: "animals", claim: "Sharks are the only animals that never get sick.", isTrue: false, explanation: "Sharks do get diseases, including cancer! While they have impressive immune systems, they are not immune to illness. This myth likely spread because sharks were mistakenly thought to never develop tumors, but research has disproven that.", funFact: "Sharks have been around for over 450 million years — they predate both dinosaurs and trees!" },
  { category: "animals", claim: "A snail can sleep for up to three years.", isTrue: true, explanation: "Snails hibernate during dry or cold periods, and if conditions are bad enough, they can stay dormant for up to three years! They seal themselves inside their shell with a layer of mucus to stay moist.", funFact: "Snails have thousands of tiny teeth on a ribbon-like tongue called a radula." },
  { category: "animals", claim: "Penguins mate for life.", isTrue: false, explanation: "While some penguin species show strong loyalty between breeding seasons, most don't actually mate for life. Many species reunite with the same partner year after year out of convenience, but partner switching is common.", funFact: "Male penguins gift females pebbles as a form of courtship — a pebble is like an engagement ring in the penguin world!" },
  { category: "animals", claim: "A group of crows is called a murder.", isTrue: true, explanation: "The collective noun for crows really is 'a murder.' The term dates back to the 15th century and may have originated from folklore associating crows with death and bad omens.", funFact: "Crows are one of the few animals that use tools and can recognize individual human faces — and they hold grudges!" },
  { category: "animals", claim: "Bats are blind.", isTrue: false, explanation: "Bats are not blind at all! They can see quite well, and many species also use echolocation — emitting sound waves and listening to the echo — to navigate and hunt in the dark. The phrase 'blind as a bat' is completely inaccurate.", funFact: "Bats are the only mammals capable of true sustained flight." },
  ...
  { category: "history", claim: "The Great Fire of London in 1666 killed thousands of people.", isTrue: false, explanation: "Remarkably, the Great Fire of London killed very few people — official records list only six deaths, though the real number may be slightly higher. It did, however, destroy around 13,000 houses and 87 churches.", funFact: "The fire started in a bakery on Pudding Lane and burned for four days." },
  { category: "history", claim: "Julius Caesar was born by caesarean section.", isTrue: false, explanation: "This is almost certainly a myth. In ancient Rome, caesarean sections were only performed when the mother was dying or already dead, yet Caesar's mother Aurelia lived long after his birth. The origin of the term 'caesarean' is still debated by historians.", funFact: "Caesar was once kidnapped by pirates, and after his release he raised a fleet, captured them, and had them executed." },
  { category: "history", claim: "Ancient Romans used urine as mouthwash.", isTrue: true, explanation: "Romans actually imported urine from as far as Portugal to use as a mouthwash and teeth whitener! The ammonia in urine is an effective cleaning agent. The practice was common enough that Emperor Nero taxed the trade of urine.", funFact: "Roman concrete was so durable that many structures built 2,000 years ago are still standing today." },
  { category: "history", claim: "The first Olympic Games included a race where runners carried torches.", isTrue: false, explanation: "The ancient Greek Olympics, starting in 776 BC, had no torch relay race. The modern torch relay was introduced at the 1936 Berlin Olympics — it was actually invented by the Nazis as a propaganda spectacle.", funFact: "Women were forbidden from even watching the ancient Olympics under penalty of death." },
  { category: "history", claim: "The Eiffel Tower was meant to be a temporary structure.", isTrue: true, explanation: "The Eiffel Tower was built for the 1889 World's Fair and was originally planned to be dismantled after 20 years. It was saved because it proved useful as a radio transmission tower. Gustave Eiffel himself called it an 'eyesore' by some critics.", funFact: "The Eiffel Tower grows about 6 inches taller in summer due to thermal expansion of the iron." },
  ...
  { category: "geography", claim: "Australia is wider than the Moon.", isTrue: true, explanation: "Australia measures about 4,000 km from east to west, while the Moon's diameter is only about 3,474 km. One continent on Earth is literally wider than the entire Moon!", funFact: "Australia is the only country that is also an entire continent, and it's the flattest and driest inhabited continent on Earth." },
  { category: "geography", claim: "The Dead Sea is the saltiest body of water on Earth.", isTrue: false, explanation: "The Dead Sea is incredibly salty — about 10 times saltier than the ocean — but it's not the saltiest. Don Juan Pond in Antarctica holds that record, with a salinity level so high it rarely freezes even at -50°C.", funFact: "The Dead Sea is actually a lake, not a sea, and it's shrinking at about 1 meter per year." },
  { category: "geography", claim: "Vatican City is the smallest country in the world.", isTrue: true, explanation: "Vatican City covers just 0.44 square kilometers, making it the world's smallest internationally recognized independent state. It has its own government, currency, radio station, and army (the Swiss Guard).", funFact: "Vatican City has the highest crime rate per capita in the world — mostly due to pickpocketing among tourists in such a tiny area." },
  { category: "geography", claim: "The Pacific Ocean is larger than all of Earth's landmass combined.", isTrue: true, explanation: "The Pacific Ocean covers about 165 million square kilometers. All of Earth's continents and islands combined cover only about 149 million square kilometers. The Pacific alone is bigger than all land on the planet!", funFact: "The Pacific Ocean contains more than half of the world's water." },
  { category: "geography", claim: "Africa is smaller than Russia.", isTrue: false, explanation: "Africa is actually much larger than Russia! Africa covers about 30.4 million square kilometers, while Russia covers about 17.1 million. Standard maps using Mercator projection make Russia appear much larger than it really is, distorting our perception.", funFact: "Africa is so large that the USA, China, India, and most of Europe could all fit inside it at the same time." },
  ...
  { category: "space", claim: "A year on Mars is almost twice as long as a year on Earth.", isTrue: true, explanation: "Mars takes about 687 Earth days to orbit the Sun — nearly two Earth years. If you lived on Mars, you'd only have a birthday about every two Earth years!", funFact: "A day on Mars (called a 'sol') is only slightly longer than an Earth day — about 24 hours and 37 minutes." },
  { category: "space", claim: "The International Space Station travels at about the same speed as a commercial airplane.", isTrue: false, explanation: "The ISS orbits Earth at about 28,000 km/h (17,500 mph) — over 20 times faster than a commercial airplane, which cruises at around 900 km/h. The ISS completes a full orbit of Earth every 90 minutes!", funFact: "Astronauts on the ISS see about 16 sunrises and sunsets every single day." },
  { category: "space", claim: "Space is completely silent.", isTrue: true, explanation: "In the vacuum of space, there is no medium for sound waves to travel through, making it completely silent. Explosions, even enormous ones, would produce no sound at all. This is why sci-fi movies with loud space battles are physically impossible.", funFact: "However, space does have electromagnetic waves that scientists can convert into audio — and some of them sound eerily beautiful." },
  { category: "space", claim: "The footprints left on the Moon will last forever.", isTrue: false, explanation: "While the Moon has no wind or rain to erode footprints, it is constantly bombarded by micrometeorites and solar radiation. Over millions of years, these will gradually erase the Apollo footprints — though they'll last far longer than any footprint on Earth.", funFact: "There is no 'dark side' of the Moon in terms of sunlight, but the far side has never been seen from Earth." },
  { category: "space", claim: "Jupiter's Great Red Spot is a storm that has lasted over 350 years.", isTrue: true, explanation: "The Great Red Spot is a massive anticyclonic storm that astronomers have been observing since at least 1831, and historical records suggest it may have existed since the 1600s. It's so large that Earth could fit inside it!", funFact: "The Great Red Spot is actually shrinking — it was once three times the size of Earth, but is now only slightly larger." },
  ...
  { category: "body", claim: "Humans are the only animals that cry emotional tears.", isTrue: true, explanation: "While many animals produce tears to lubricate their eyes, humans appear to be the only species that sheds tears in response to emotions. Scientists still don't fully understand why we evolved this trait.", funFact: "Crying actually has health benefits — emotional tears contain stress hormones that your body flushes out, which is why you can feel better after a good cry." },
  { category: "body", claim: "Your heart stops when you sneeze.", isTrue: false, explanation: "Your heart does not stop when you sneeze. The electrical activity of the heart is unaffected by a sneeze. The pressure change in your chest can slightly alter your heart's rhythm, but it never stops — that's just an old myth.", funFact: "Sneezes travel at up to 100 mph and can spray droplets up to 27 feet away." },
  { category: "body", claim: "Humans have more than five senses.", isTrue: true, explanation: "Beyond the classic five (sight, hearing, taste, smell, touch), humans have many more senses including proprioception (body position), thermoception (temperature), equilibrioception (balance), nociception (pain), and others. Scientists count at least 9 and some say up to 21.", funFact: "Proprioception is why you can touch your nose with your eyes closed — your body knows where your limbs are without seeing them." },
  { category: "body", claim: "Blood is blue inside your body.", isTrue: false, explanation: "Blood is always red inside your body. It's bright red when oxygenated and dark red (not blue) when deoxygenated. Veins look bluish through the skin because of the way different wavelengths of light penetrate and reflect through tissue.", funFact: "The only animals with genuinely blue blood are horseshoe crabs — their blood contains copper instead of iron." },
  { category: "body", claim: "Your liver can completely regenerate itself.", isTrue: true, explanation: "The liver is the only internal organ capable of natural regeneration. Even if up to 75% of the liver is removed, it can grow back to its original size. This is what makes living-donor liver transplants possible.", funFact: "The liver performs over 500 different functions and filters about 1.4 liters of blood per minute." },

  // FOOD
  { category: "food", claim: "White chocolate isn't actually chocolate.", isTrue: true, explanation: "White chocolate contains cocoa butter but none of the cocoa solids that give regular chocolate its flavor and color. Technically, it's made from the fat of the cocoa bean, not the bean itself!", funFact: "It takes about 400 cocoa beans to make just one pound of chocolate." },
  { category: "food", claim: "Carrots were originally purple, not orange.", isTrue: true, explanation: "Carrots were originally purple or yellow. Orange carrots were developed by Dutch growers in the 17th century, possibly to honor William of Orange. Purple carrots are still grown today!", funFact: "Eating too many carrots can actually turn your skin slightly orange — a harmless condition called carotenemia." },
  { category: "food", claim: "Sushi means 'raw fish' in Japanese.", isTrue: false, explanation: "Sushi actually refers to the seasoned vinegared rice, not the fish. The word comes from an old Japanese term meaning 'sour-tasting.' Sushi can be made with cooked ingredients or even no fish at all!", funFact: "The California roll was invented in North America, not Japan — it was created in the 1960s to appeal to Western diners." },
  { category: "food", claim: "Honey is the only food that never spoils.", isTrue: true, explanation: "Honey's low moisture content, acidic pH, and natural hydrogen peroxide production make it virtually immune to bacterial growth. Archaeologists have found 3,000-year-old honey in Egyptian tombs that was still perfectly edible!", funFact: "Bees must visit about 2 million flowers and fly over 55,000 miles to produce just one pound of honey." },
  { category: "food", claim: "Bananas are technically berries, but strawberries are not.", isTrue: true, explanation: "Botanically, a berry develops from a single flower with one ovary and has seeds embedded in the flesh. Bananas fit this definition perfectly. Strawberries are actually 'accessory fruits' because the seeds sit on the outside!", funFact: "Avocados, grapes, and even watermelons are also classified as berries!" },
  { category: "food", claim: "Spicy food kills your taste buds.", isTrue: false, explanation: "Capsaicin, the compound that makes food spicy, triggers pain receptors — not taste receptors. It creates a burning sensation but doesn't damage taste buds at all. Your taste buds naturally regenerate every 10-14 days anyway!", funFact: "Birds can't feel the burn of capsaicin at all, which helps peppers spread their seeds through bird droppings." },
  { category: "food", claim: "Peanuts are not actually nuts.", isTrue: true, explanation: "Peanuts are legumes — they grow underground in pods, just like lentils and chickpeas. True nuts like almonds, walnuts, and cashews grow on trees. Peanuts are more closely related to beans than to any tree nut!", funFact: "It takes about 540 peanuts to make a 12-ounce jar of peanut butter." },
  { category: "food", claim: "Eating celery burns more calories than it contains.", isTrue: false, explanation: "This is a popular diet myth! A stick of celery has about 6 calories, and digesting it burns only about half a calorie. While celery is very low in calories, no food has 'negative calories' — digestion never uses more energy than the food provides.", funFact: "Celery is 95% water, making it one of the most hydrating foods you can eat." },
  { category: "food", claim: "Apples are more effective at waking you up than coffee.", isTrue: true, explanation: "Apples contain natural sugars (fructose) that provide a steady energy boost, plus they're high in fiber which regulates the sugar release. Unlike caffeine, they don't cause a crash. The act of chewing also stimulates alertness!", funFact: "There are over 7,500 varieties of apples grown worldwide — it would take over 20 years to try one a day." },
  { category: "food", claim: "Fortune cookies were invented in China.", isTrue: false, explanation: "Fortune cookies were actually invented in California! They're believed to have been created by Japanese-American immigrants in the early 1900s. Fortune cookies are virtually unknown in China — they're an American invention.", funFact: "About 3 billion fortune cookies are made each year, and the vast majority are produced by one company in the U.S." },
  { category: "food", claim: "Chocolate was once used as currency.", isTrue: true, explanation: "The ancient Aztecs and Maya used cacao beans as currency. Cacao was so valuable that a turkey cost 100 beans and an avocado cost about 3 beans. Spanish conquistadors initially valued gold over cacao, much to the locals' disbelief.", funFact: "The word 'chocolate' comes from the Aztec word 'xocolatl,' meaning 'bitter water' — it was originally consumed as an unsweetened drink." },
  { category: "food", claim: "Tomatoes are vegetables.", isTrue: false, explanation: "Botanically, tomatoes are fruit — specifically a berry — because they develop from the flower of the plant and contain seeds. However, in 1893 the U.S. Supreme Court ruled tomatoes were legally a vegetable for tariff purposes. Both are technically correct in different contexts!", funFact: "There are over 10,000 varieties of tomatoes, ranging in color from red, orange, and yellow to green, purple, and even black." },
  { category: "food", claim: "Eating ice cream can give you brain freeze.", isTrue: true, explanation: "Brain freeze (sphenopalatine ganglioneuralgia) happens when something cold touches the roof of your mouth, rapidly cooling blood vessels and triggering pain receptors. Your brain interprets the signal as coming from your forehead — hence the 'freeze.'", funFact: "You can stop brain freeze by pressing your tongue to the roof of your mouth to warm it up, or by drinking something warm." },
  { category: "food", claim: "Microwaving food destroys all its nutrients.", isTrue: false, explanation: "Microwaving is actually one of the best cooking methods for preserving nutrients! Because it cooks food quickly and with little water, fewer nutrients are lost. Boiling vegetables, by contrast, can leach out up to 50% of their water-soluble vitamins.", funFact: "The microwave was invented by accident in 1945 when an engineer noticed a chocolate bar in his pocket had melted near a radar device." },
  { category: "food", claim: "Coconut water can be used as a substitute for blood plasma in emergencies.", isTrue: true, explanation: "During World War II and in remote medical emergencies, doctors have used coconut water intravenously as a short-term substitute for plasma because it's sterile, isotonic, and compatible with human blood. It's been documented in peer-reviewed medical journals.", funFact: "Coconut water is sometimes called 'nature's sports drink' — it naturally contains electrolytes like potassium, sodium, and magnesium." },
];
